...
[_QWERTY] = LAYOUT(
  ...
  KC_LCTL,   MT_A,    MT_S,    MT_D,    MT_F,    KC_G,                   KC_H,    MT_J,    MT_K,    MT_L,    MT_NTIL, KC_QUOT,
  KC_LSFT,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                   KC_N,    KC_M,    TD_COMMA,TD_DOT,  TD_EQUAL,KC_RSFT,
...
[_NUMBERS] = LAYOUT(
  ...
  _______,   _______, _______, _______, _______, _______,                _______, _______, KC_DOT,  KC_COMM, KC_RBRC, _______,
...
[_SYMBOLS] = LAYOUT(
  ...
  _______,   KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, KC_PIPE,                KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_TILD, KC_F12,
  _______,   KC_LPRN, KC_RPRN, KC_LABK, KC_RABK, KC_GRV,                 KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_UNDS, KC_COLN,
